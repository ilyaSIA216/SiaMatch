...
function hideAnimatedWelcomeScreen() {
  ...
  // 0-2 сек: Клевер
  // 2-3.5 сек: Заголовок "SiaMatch"
  // 3.5-4.5 сек: Текст "Любовь начинается здесь"
  // 4.5-7.5 сек: Рисуется сердце вокруг текста (3 секунды)
  // 7.5-8 сек: Пауза
  // Итого: 8 секунд
  ...
  }, 8000); // Общее время показа 8 секунд
}
